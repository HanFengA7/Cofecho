...
(76, 'rewrite', '<div><span style=\"\">if (!-e $request_filename) {</span></div><div><span style=\"\">rewrite ^/(.*)$ /index.php?s= last; break;&nbsp;</span></div><div><span style=\"\">rewrite ^/(d+)/(.+)/ /$2?cid=$1 last;</span></div><div><span style=\"\">}</span></div>', '2020-08-30 17:16:23', '2020-08-30 17:16:23');
...
--
ALTER TABLE `Cofecho_Contents`
  MODIFY `cid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
