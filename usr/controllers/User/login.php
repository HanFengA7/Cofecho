...
$DB_s_username = $Cofecho_User_Class->QInfo_Root('username');
$DB_s_password = $Cofecho_User_Class->QInfo_Root('password');
...
if (isset($_POST['login'])) {
	...
	$password = trim($_POST['password']);
		...
		} elseif (($username != $DB_s_username ) || ($Cofecho_User_Class->Password_V($password) !=1 )) {
